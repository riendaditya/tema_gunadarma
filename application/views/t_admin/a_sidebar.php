		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="<?php echo base_url('admin/dashboard') ?>" class="brand-link">
				<img src="<?php echo base_url('') ?>/assets/upload/logo.jpeg" class="brand-image img-circle elevation-3" style="opacity: .8">
				<span class="brand-text font-weight-light">Tema Gunadarma
			</a>
					...
					<ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="<?php echo base_url('admin/data_naskah') ?>" class="nav-link">
						...
						<li class="nav-item">
							<a href="<?php echo base_url('admin/achievement') ?>" class="nav-link">
						...
						<li class="nav-item">
							<a href="<?php echo base_url('auth/ch_pass') ?>" class="nav-link">
